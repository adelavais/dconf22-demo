 ...
 */
module Google.Apis.Drive.v3.Data.PermissionList;
...
public struct PermissionList {
   ...
   */
  public PermissionList setKind(string _kind) {
    this._kind = _kind;
    return this;
  }
   ...
   */
  public PermissionList setNextPageToken(string _nextPageToken) {
   ...
   */
  public PermissionList setPermissions(Permission[] _permissions) {
