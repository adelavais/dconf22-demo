 ...
 */
module Google.Apis.Drive.v3.Data.ReplyList;
...
public struct ReplyList {
   ...
   */
  public ReplyList setKind(string _kind) {
    this._kind = _kind;
    return this;
  }
   ...
   */
  public ReplyList setNextPageToken(string _nextPageToken) {
   ...
   */
  public ReplyList setReplies(Reply[] _replies) {
